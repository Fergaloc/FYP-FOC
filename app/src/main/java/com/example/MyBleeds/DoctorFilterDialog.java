...
public class DoctorFilterDialog extends AppCompatDialogFragment {
    public static final String PATIENT_ID = "patientid";
    private Spinner spinnerLocation;
    private Spinner spinnerSeverity;
    private Spinner spinnerCause;
    private DoctorFilterDialogListener doctorFilterDialogListener;
...
//resets textfields and spinners
    ...
    public void onAttach(Context context) {
        ...
        try {
            doctorFilterDialogListener = (DoctorFilterDialogListener) context;
    ...
    public interface DoctorFilterDialogListener {
    ...
    private void saveFilterData(){
        ...
        databaseBleed = FirebaseDatabase.getInstance().getReference().child("bleeds").child(id);
        ...
        Intent Filterintent = new Intent(getActivity(), ViewPatientBleeds.class);

        Filterintent.putExtra("PATIENT_ID", id);
