...
public class parentFilterDialog extends AppCompatDialogFragment {
    public static final String PATIENT_ID = "patientid";
    private Spinner spinnerLocation;
    private Spinner spinnerSeverity;
    private Spinner spinnerCause;
    private ParentFilterDialogListener parentfilterDialogListener;
...
//resets textfields and spinners
    ...
    public void onAttach(Context context) {
        ...
        try {
            parentfilterDialogListener = (ParentFilterDialogListener) context;
    ...
    public interface ParentFilterDialogListener {
    ...
    private void saveFilterData(){
        ...
        Intent Filterintent = new Intent(getActivity(), ParentViewBleeds.class);
